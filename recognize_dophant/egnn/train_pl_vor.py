...
if __name__ == '__main__':
    train_dataset = AtomDataset_v2(root='{}/train/'.format(DATA_PATH))
    valid_dataset = AtomDataset_v2(root='{}/valid/'.format(DATA_PATH))
    test_dataset = AtomDataset_v2(root='{}/test/'.format(DATA_PATH))
