...
def load_data_plot_cz(json_path):
    data_dict = {
        'atom': 0,
        'cz': 1
    }
...
def load_data_v2(json_path,max_edge_lengh):
    data_dict = {
        '0': 0,
        '1': 1,
        '2': 2,
...
def load_data_v2_plot(json_path,max_edge_length):
    data_dict = {
        '0': 0,
        '1': 1,
        '2': 2,
...
def load_data_v2_plot_jj(json_path,max_edge_length):
    data_dict = {
        'Norm': 0,
        'JJ': 1,
        # '2': 2,
...
def load_data_v2_plot_cz(json_path,max_edge_length):
    data_dict = {
        'atom': 0,
        'cz': 1,
        # '2': 2,
...
def load_data_v2_plot_kw(json_path,max_edge_length):
    # data_dict = {
    #     'atom': 0,
    #     'cz': 1,
    #     # '2': 2,
...
class AtomDataset_vor(InMemoryDataset):
    ...
    def process(self):
        ...
        for json_path in json_lst:
            base_name = json_path.split('/')[-1].split('.')[0]
            points, edge_index, labels, lights = load_data_v2(json_path,max_edge_lengh)
